...
public class UITextureCustomInspector : UITextureInspector
{
	...
	protected override bool ShouldDrawProperties()
	{
		...
		if (sp != null)
		{
			...
			if (texture == null)
			{
				var maskTextureScriptableObject = sp.objectReferenceValue as MaskTextureScriptableObject;
				if (maskTextureScriptableObject != null)
					texture = maskTextureScriptableObject.GetMaskTexture();
			}
			NGUISettings.texture = texture;
			mTexCustom.mainTexture = texture;
		}
